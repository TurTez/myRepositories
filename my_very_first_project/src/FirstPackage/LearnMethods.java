...
public class LearnMethods {
    ...
    public static int docStrExample(int a, int b){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(methodEx2(500,600));
  ...
  static void methodExample(){
    ...
    /**
     *This is medhod calculator two numbers
     * @param - an int number need to be added;
     * @param - an int number need to be added;
     * @return num1+num2;
     */
